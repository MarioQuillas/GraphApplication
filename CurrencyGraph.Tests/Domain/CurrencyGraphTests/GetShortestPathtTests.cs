...
namespace CurrencyGraph.Tests.Domain.CurrencyGraphTests
{
    ...
    {
        private bool CompareEqualityPaths(IEnumerable<PathStep<Currency, WeightedBidrectionalEdge<Currency>>> path1,
        ...
        public void should_return_one_travelled_edge_for_trivial_case()
        {
            ...
            {
                new ChangeRate("EUR", "JPY", (decimal) 0.6571),
            };

            var currencyGraph = new CurrencyGraph.Domain.CurrencyGraph(rates, new ChangeRateComputationStrategy(4));
            ...
            {
                new PathStep<Currency, WeightedBidrectionalEdge<Currency>>("EUR", "JPY", null),
            };
        ...
        public void should_return_correct_value_in_example_test_case()
        {
            ...
            var actualResult = new List<PathStep<Currency, WeightedBidrectionalEdge<Currency>>>()
            {
                new PathStep<Currency, WeightedBidrectionalEdge<Currency>>("EUR", "CHF", null),
                new PathStep<Currency, WeightedBidrectionalEdge<Currency>>("CHF", "AUD", null),
                new PathStep<Currency, WeightedBidrectionalEdge<Currency>>("AUD", "JPY", null),
            };
