namespace CurrencyGraph.Tests.Domain.DomainServicesTests
{
    ...
    public class CalculateTests
    {
        ...
        public void should_fail_when_there_is_no_conversion_path_in_simple_case()
        {
            ...
            var rates = new List<ChangeRate>() { new ChangeRate("EUR", "CHF", (decimal)2.111), };
        ...
        public void should_return_correct_inverted_value_for_one_input_value_with_quantity_more_than_one()
        {
            ...
            var rates = new List<ChangeRate>() { new ChangeRate("JPY", "EUR", (decimal)0.119), };

            var result = new DomainServices().Calculate(deviceSource, deviceTarget, 459, rates);
        ...
        [TestMethod]
        public void
            should_return_correct_inverted_value_for_one_input_value_with_quantity_one_and_change_rate_bigger_than_one()
        {
            var deviceSource = new Currency("EUR");
            var deviceTarget = new Currency("JPY");

            var rates = new List<ChangeRate>() { new ChangeRate("JPY", "EUR", (decimal)1.789), };
        ...
        public void should_return_correct_lower_rounded_value_for_one_input_value()
        {
            ...
            var rates = new List<ChangeRate>() { new ChangeRate("EUR", "JPY", (decimal)1.23), };
        ...
        public void should_return_correct_rounded_value_for_one_input_value_and_quantity_different_than_one()
        {
            ...
            var rates = new List<ChangeRate>() { new ChangeRate("EUR", "JPY", (decimal)2.111), };
        ...
        public void should_return_correct_upper_rounded_value_for_one_input_value()
        {
            ...
            var rates = new List<ChangeRate>() { new ChangeRate("EUR", "JPY", (decimal)1.789), };
        ...
        public void should_return_correct_value_for_custom_case_with_more_than_three_possible_conversion_paths()
        {
            ...
            var result = new DomainServices().Calculate(deviceSource, deviceTarget, 48963, rates);
        ...
        public void should_return_correct_value_for_custom_case_with_one_conversion_path()
        {
            ...
            var result = new DomainServices().Calculate(deviceSource, deviceTarget, 456, rates);
        ...
        public void should_return_correct_value_for_example_case()
        {
            ...
            var result = new DomainServices().Calculate(deviceSource, deviceTarget, 550, rates);
        ...
        public void should_return_same_change_rate_when_only_one_input_data()
        {
            ...
            var rates = new List<ChangeRate>() { new ChangeRate("EUR", "JPY", (decimal)1), };
